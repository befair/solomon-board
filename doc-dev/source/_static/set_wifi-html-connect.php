...
$file = fopen("/var/lib/wifi_config/wifi_config.txt", "w") or die("Unable to open file!");
...
$file_invt = fopen("/var/lib/wifi_config/wifi_config_invt.txt", "w") or die("Unable to open file!");
